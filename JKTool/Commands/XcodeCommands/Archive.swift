...
extension JKTool {
    struct Archive: ParsableCommand {
        ...
        mutating func run() {
            ...
            do {
                try shellOut(to: .archive(scheme: scheme, isWorkspace: project.projectType.isWorkSpace(),projectName: project.projectType.entrance(), projectPath: project.directoryPath, configuration: configuration, sdk: configs.sdk), at: project.directoryPath)
            } catch  {
